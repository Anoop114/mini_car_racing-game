...
public class LobbyMainPanel : MonoBehaviourPunCallbacks
{
    ...
    public void Awake()
    {
        ...
        FeedbackText = Feedback.GetComponent<FeedBack>();
    ...
    public override void OnJoinedRoom()
    {
        ...
        foreach (Player p in PhotonNetwork.PlayerList)
        {
            ...
            if (p.CustomProperties.TryGetValue(CarGame.PLAYER_READY, out isPlayerReady))
            {
        ...
        {
            {CarGame.PLAYER_LOADED_LEVEL, false}
        };
    ...
    public override void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
    {
        ...
        {
            object isPlayerReady;
            if (changedProps.TryGetValue(CarGame.PLAYER_READY, out isPlayerReady))
            {
                entry.GetComponent<PlayerList>().SetPlayerReady((bool) isPlayerReady);
            }
        }
